      ...
      <header className="sticky top-0 z-40 border-b border-border/50 glass-panel">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          ...
          <nav className="hidden items-center gap-1 text-sm text-muted-foreground md:flex">
            <Link href="/" className="rounded-lg px-3 py-1.5 transition-colors hover:bg-accent/60 hover:text-foreground">
              Home
            </Link>
            {NAV.map((item) => (
              <Link
          ...
          <div className="hidden items-center gap-2 sm:flex">
            <Link href="/mission-control" className={buttonVariants({ variant: "ghost", size: "sm" })}>
              Mission Control
            </Link>
            <a href={MAIN_APP_SIGNUP} className={buttonVariants({ size: "sm", className: "btn-primary-cta" })}>
              Free trial
            </a>
          </div>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[min(100vw,320px)] border-border/60 bg-background">
              <SheetHeader>
                <SheetTitle className="font-display text-gradient-fx">{AGENTS_SITE_NAME}</SheetTitle>
              </SheetHeader>
              <nav className="mt-6 flex flex-col gap-2">
                <Link href="/" className="rounded-lg px-3 py-2 hover:bg-muted">
                  Home
                </Link>
                {NAV.map((item) => (
      ...
      <footer className="border-t border-border/60 bg-muted/20">
        <div className="mx-auto max-w-6xl px-4 py-12">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link href="/agents/social-media-agent" className="hover:text-foreground">
                    Agent catalog
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  <a href={MAIN_APP_URL} className="hover:text-foreground">
                    AiWorkers.vip (platform)
                  </a>
                </li>
                <li>
                  <a href={MAIN_APP_PRIVACY} className="hover:text-foreground">
                    Privacy
                  </a>
                </li>
                <li>
                  <a href={MAIN_APP_TERMS} className="hover:text-foreground">
                    Terms
                  </a>
                </li>
              </ul>
          ...
          <p className="mt-10 text-xs text-muted-foreground">
            © {new Date().getFullYear()} Agents.AIWorkers.vip
          </p>
        </div>
      </footer>
    </div>
