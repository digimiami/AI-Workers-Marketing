...
import { processDueEmailOutbox } from "@/services/email/outboxService";

/**
 * Vercel Cron: GET /api/cron/email-outbox
 * Optional: ?organizationId=<uuid> to scope to one org.
...
export async function GET(request: Request) {
  ...
  const result = await processDueEmailOutbox(admin, {
