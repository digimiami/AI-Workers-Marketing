...
import { AgentMissionControlLink } from "@/components/agents-site/agent-mission-link";
...
import type { AgentDefinition } from "@/lib/agents-site/agent-definition";
    ...
    <section className="border-t border-border/50">
      <div className="mkt-page pb-16">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          Deploy the {agent.shortTitle} worker alongside others in <AgentMissionControlLink />
        </p>
      </div>
    </section>
  );
